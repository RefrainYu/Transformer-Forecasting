...
def preprocess(file_path_name, output_path_name):
    """
    Preprocess the data and fill missing values with mean
...
if __name__ == '__main__':
    ...
    # preprocess('data/1A-Real-Trina-Test.csv', 'data/1A-Real-Trina-Test-new.csv')
    preprocess('data/1A-Trina-To-Process.csv', 'data/1A-Trina-To-Process.csv')
